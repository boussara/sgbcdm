...
void CWosaXFSTestView::OnButtonSyncOpen()
{
	...
	m_strResult +=m_strLocalService.GetBuffer(0);
	m_strResult += "Openning .\r\n";

	WriteScript("LogicalService==>", m_strLocalService.GetBuffer(0), _T(""));
